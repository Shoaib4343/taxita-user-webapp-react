  ...
  return (
    <div ref={dropdownRef} className={`relative ${containerClassName}`}>
      <div
        ...
        className={`w-full bg-transparent text-gray-900 cursor-pointer flex items-center justify-between ${className}`}
      >
          ...
          <div>
            ...
            >
              ...
              <CustomDropdown
                ...
                showSearch={false}
                className="w-full bg-transparent outline-none border-none p-0 m-0 rounded-none shadow-none ring-0"
