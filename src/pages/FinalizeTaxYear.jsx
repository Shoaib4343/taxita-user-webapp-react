  ...
  return (
    <div className="min-h-screen p-8 bg-white rounded-2xl">
      ...
      <div className="flex items-center justify-end text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-700 font-semibold">Finalize Tax Year</span>
      </div>

      {/* Header */}
      <div className="text-center mb-12">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-4">
          Finalize Your <span className="text-blue-600">Tax Year</span>
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          With <span className="font-semibold text-blue-600">Taxita</span> you get a full accountancy service with no further costs.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8">
          <h3 className="text-xl font-semibold text-gray-800 mb-6">HERE IS WHAT YOU GET!</h3>
          <ul className="space-y-2">
            {features.map((feature, i) => (
              <li key={i} className="flex items-start gap-3 group hover:translate-x-1 transition">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-500 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 flex flex-col justify-between">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100">annually</p>
