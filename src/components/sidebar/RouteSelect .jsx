...
//       className={`flex items-center justify-start gap-2 w-full rounded px-2 py-1.5 text-sm transition-all cursor-pointer ${
//         selected
//           ? "bg-white text-stone-950  shadow"
//           : "hover:bg-stone-200 hover:text-stone-950  text-stone-100"
//       }`}
//     >
